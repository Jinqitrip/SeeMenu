// SeeMenu — sample content (Japanese izakaya / ramen menu)
// All dish data is shared across both visual variants.
...
const SAMPLE_MENU = [
  {
    ...
    tag: '招牌',
    swatch: ['#f3d9b5', '#c98452'], // bowl colors
  },
  {
    id: 'shoyu',
    jp: '醤油ラーメン',
...
// Multi-person room — selections by member
const ROOM_MEMBERS = [
...
// Final order summary — what gets shown to the waiter
const FINAL_ORDER = [
...
window.SAMPLE_MENU = SAMPLE_MENU;
window.ROOM_MEMBERS = ROOM_MEMBERS;
window.FINAL_ORDER = FINAL_ORDER;
window.MENU_BY_ID = Object.fromEntries(SAMPLE_MENU.map(m => [m.id, m]));
